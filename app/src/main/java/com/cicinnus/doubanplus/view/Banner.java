...
//    private List<ImageView> iv_dots;
    ...
    public void setPic(List<PicBean> bannerPicBeen) {
        this.picBeen = bannerPicBeen;
        reset();
    }

    public void setErrorPic(List<PicBean> errorPic) {
    ...
    private void initUI() {
        ...
        for (int i = 0; i <= len + 1; i++) {
            ...
            if (i == 0) {
                Glide.with(getContext()).load(picBeen.get(len - 1).picUrl).into(iv);

            } else if (i == len + 1) {
                Glide.with(getContext()).load(picBeen.get(0).picUrl).into(iv);

            } else {
                Glide.with(getContext()).load(picBeen.get(i - 1).picUrl).into(iv);
        ...
        vp.setCurrentItem(1);
        vp.setPageTransformer(false, new CustomViewPagerTransformer());
    ...
    public void onClick(View v) {
        if (mItemClickListener != null && stopScroll) {
            PicBean bean = picBeen.get(vp.getCurrentItem() - 1);
    ...
    public interface OnItemClickListener {
        void click(View v, PicBean bean);
    }
    ...
    private class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            if (onPageSelectedListener != null) {
                onPageSelectedListener.onScrolled(position);
            }
        }
    ...
    public static class PicBean {
        ...
        public PicBean(String picUrl, int id) {
            this.picUrl = picUrl;
            this.id = id;
        }
    }
